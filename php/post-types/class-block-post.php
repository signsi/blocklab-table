...
?>
	...
	public function render_properties_meta_box()
	{
		...
		<p>
			...
			<input name="post_name" type="text" id="block-properties-slug" value="<?php echo esc_attr($post->post_name); ?>" />
		</p>
		<p class="description">
			<?php
			esc_html_e(
		...
		<p>
			...
			<input name="block-properties-icon" type="hidden" id="block-properties-icon" value="<?php echo esc_attr($block->icon); ?>" />
		...
		<p>
			...
			<span class="block-properties-category-custom">
				...
				<input name="block-properties-category-name" type="text" id="block-properties-category-name" value="" />
			</span>
		</p>
		<p>
			...
			<input name="block-properties-keywords" type="text" id="block-properties-keywords" value="<?php echo esc_attr(implode(', ', $block->keywords)); ?>" />
		</p>
		<p class="description">
			<?php
			esc_html_e(
	...
	?>
		<div class="block-fields-row" data-uid="<?php echo esc_attr($uid); ?>">
			...
			<div class="block-fields-edit">
				<table class="widefat">
					<tr class="block-fields-edit-label">
						...
						<td>
							<input name="block-fields-label[<?php echo esc_attr($uid); ?>]" type="text" id="block-fields-edit-label-input_<?php echo esc_attr($uid); ?>" class="regular-text" value="<?php echo esc_attr($field->label); ?>" data-sync="block-fields-label_<?php echo esc_attr($uid); ?>" <?php echo $is_field_disabled ? 'readonly="readonly"' : ''; ?> />
							<?php if ($is_field_disabled) : ?>
								<input name="block-is-disabled-pro-field[<?php echo esc_attr($uid); ?>]" type="hidden" value="true" />
							<?php endif; ?>
						</td>
					</tr>
					<tr class="block-fields-edit-name">
						...
						<td>
							<input name="block-fields-name[<?php echo esc_attr($uid); ?>]" type="text" id="block-fields-edit-name-input_<?php echo esc_attr($uid); ?>" class="regular-text" value="<?php echo esc_attr($field->name); ?>" data-sync="block-fields-name-code_<?php echo esc_attr($uid); ?>" <?php echo $is_field_disabled ? 'readonly="readonly"' : ''; ?> />
						</td>
					</tr>
					<tr class="block-fields-edit-control">
						...
						<td>
							<select name="block-fields-control[<?php echo esc_attr($uid); ?>]" id="block-fields-edit-control-input_<?php echo esc_attr($uid); ?>" data-sync="block-fields-control_<?php echo esc_attr($uid); ?>" <?php disabled($is_field_disabled); ?>>
								<?php
			...
			if ($parent_uid) {
			?>
				<input type="hidden" name="block-fields-parent[<?php echo esc_attr($uid); ?>]" value="<?php echo esc_attr($parent_uid); ?>" />
			<?php
			}
			?>
		</div>
